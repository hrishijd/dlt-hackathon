...
func TokenDepositHandler(vLog types.Log) {
	...
	supplyDepositedEvent := supply.SupplyTokensDeposited{}
	supplyContractAbi.UnpackIntoInterface(&supplyDepositedEvent, "TokensDeposited", vLog.Data)
